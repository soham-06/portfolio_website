...
const links = [
  { href: "https://github.com/soham-06", icon: <GitHubIcon />, label: "GitHub" },
  { href: "mailto:thipsesoham@gmail.com", icon: <MailIcon />, label: "Email" },
  { href: "https://leetcode.com", icon: <LeetCodeIcon />, label: "LeetCode" },
  { href: "https://drive.google.com/file/d/1DkIUr6frKXF8L-W3_tUD1b3tqlyRwqgb/view?usp=sharing", icon: <ResumeIcon />, label: "Resume" },
];
...
export default function SocialBar() {
  return (
    <div className="socialBar">
      {links.map((l) => (
        <a key={l.label} href={l.href} target="_blank" rel="noopener noreferrer" className="socialLink">
          {l.icon} {l.label} <span className="arrow">↗</span>
        </a>
      ))}
    </div>
  );
